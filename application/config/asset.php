...
$config['css_path'] 		= 'assets/themes/';
$config['download_path'] 	= 'assets/download/';
$config['less_path'] 		= 'assets/less/';
$config['js_path'] 			= 'assets/themes/';
$config['img_path'] 		= 'assets/themes/';
$config['swf_path'] 		= 'assets/swf/';
$config['upload_path'] 		= 'assets/upload/';
$config['xml_path'] 		= 'assets/xml/';

//my extension
$config['theme_css_path'] 	= 'assets/login/theme/css/';
$config['theme_js_path'] 	= 'assets/login/theme/js/';
$config['theme_img_path'] 	= 'assets/login/theme/img/';
