...
{
    function css_url($theme='default')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('css_path').$theme.'/css/';
    }
}
/**
 * Get theme css URL (evil)
 *
 * @access  public
 * @return  string
 */
if ( ! function_exists('theme_css_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('theme_css_path');
    }
}
...
{
    function js_url($theme='default')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('js_path').$theme.'/js/';
    }
}
/**
 * Get theme js URL
...
{
    function theme_js_url()
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('theme_js_path');
    }
}
...
{
    function img_url($theme='default')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('img_path').$theme.'/images/';
    }
}
/**
 * Get theme image URL 'new my url'
 *
 * @access  public
 * @return  string
 */
if ( ! function_exists('theme_img_url'))
{
    function theme_img_url($theme='default')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('theme_img_path').$theme;
    }
}
...
{
    function theme_css($file,$theme='default', $media='all')
    {
        return '<link rel="stylesheet" type="text/css" href="' . css_url($theme) . $file . '" media="' . $media . '">'."\n";
    }
}
...
{
    function theme_js($file, $theme='default', $atts = array())
    {
        $element = '<script type="text/javascript" src="' . js_url($theme) . $file . '"';
