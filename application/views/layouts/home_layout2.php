...
<link rel="stylesheet" href="<?=$base;?>fonts/flaticon/flaticon.css">
<link rel="stylesheet" href="<?=$base;?>css/slick.css"/>
<link rel="stylesheet" href="<?=$base;?>css/liMarquee.css">
<link rel="stylesheet" href="<?=$base;?>css/colorbox.css">
<link rel="stylesheet" href="<?=$base;?>css/jquery.nouislider.css">
<!-- Custom styles for this template -->
<link href="<?=$base;?>css/coolbaby.css" rel="stylesheet">
<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="<?=$base;?>rs-plugin/css/settings.css" media="screen"/>
<link rel="stylesheet" type="text/css" href="<?=$base;?>rs-plugin/css/extralayers.css" media="screen"/>
</head>
...
<div id="outer">
	<div id="outer-canvas">
							...
							<div class="hidden">
								<div id="drop-shopcart" class="shoppingcart-box">
									...
									<div class="list animate-delay-outer">
										<div class="item animate-delay fadeInRight">
											<div class="image">
												<a href="product.html" class="preview-image"><img src="<?=base_url();?>assets/images/products/product-03.jpg" alt=""></a>
											</div>
											<div class="description">
										...
										<div class="item animate-delay fadeInRight">
											<div class="image">
												<a href="product.html" class="preview-image"><img src="<?=base_url();?>assets/images/products/product-05.jpg" alt=""></a>
											</div>
											<div class="description">
												<a href="#">Mauris et ligula quis</a><strong class="price">1 x $44.95</strong>
											</div>
		...
		<div class="back-to-top">
			<span class="arrow-up"><img src="<?=base_url();?>assets/images/icon-scroll-arrow.png" alt=""></span><img src="<?=base_url();?>assets/images/icon-scroll-mouse.png" alt="">
		</div>
		<!-- //end Back to top -->
					...
					<div class="header-left col-sm-5 col-md-8">
						<div class="row">
							...
							<div class="navbar-logo col-xs-10 col-sm-10 col-md-6 text-center">
								<a href="index.html"><img src="<?=base_url();?>assets/images/logo.png" alt="Coolbaby"></a>
							</div>
							<!-- //end Logo -->
			...
			<div class="navbar-main-menu-outer hidden-xs">
				<div class="container">
					<dl class="navbar-main-menu">
						...
						<dd></dd>
						<dt class="item"><a href="#" class="btn-main">lAYOUT</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="index.html">Default</a></li>
							<li><a href="index-simple.html">Simple</a></li>
							<li><a href="index-gallery.html">Gallery</a></li>
							<li><a href="index-land.html">Land</a></li>
							<li><a href="index-boxed.html">Boxed</a></li>
							<li><a href="index-boxed-land.html">Boxed-Land</a></li>
							<li><a href="index-newsletter.html">Popup on Load</a></li>
							<li><a href="index-marina-grey.html">Marina Grey</a></li>
							<li><a href="index-bio.html">Bio Product</a></li>
							<li><a href="index-kids.html">Kids</a></li>
							<li><a href="index-art.html">Art Gallery</a></li>
							<li><a href="index-lingerie.html">Lingerie</a></li>
							<li><a href="index-tools.html">Tools</a></li>
						</ul>
						</dd>
						<dt class="item"><a href="#" class="btn-main">Listing</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="listing.html">With Left Column</a></li>
							<li><a href="listing-gallery.html">Gallery Listing</a></li>
							<li><a href="listing-no-left.html">No Left Column</a></li>
							<li><a href="listing-categories.html">Only Categories</a></li>
						</ul>
						</dd>
						<dt class="item"><a href="#" class="btn-main">Product</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="product-classic.html">Classic</a></li>
							<li><a href="product.html">Creative</a></li>
							<li><a href="product-classic-elevatezoom.html">Classic Free Zoom</a></li>
							<li><a href="product-elevatezoom.html">Creative Free Zoom</a></li>
						</ul>
						</dd>
						<dt class="item"><a href="#" class="btn-main">Blog</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="blog.html">Blog Posts</a></li>
							<li><a href="blog-single.html">Blog Post Page</a></li>
						</ul>
						</dd>
						<dt class="item"><a href="#" class="btn-main">Gallery</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="gallery-two-columns.html">Two columns</a></li>
							<li><a href="gallery-three-columns.html">Three columns</a></li>
							<li><a href="gallery-four-columns.html">Four columns</a></li>
							<li><a href="gallery-five-columns.html">Five columns</a></li>
							<li><a href="gallery-single.html">Single Page</a></li>
						</ul>
						</dd>
						<dt class="item"><a href="#" class="btn-main">Pages</a></dt>
						<dd class="item-content content-small">
						<div class="megamenuClose">
						</div>
						<ul class="row-list">
							<li><a href="page-404.html">404 Page</a></li>
							<li><a href="page-infographic.html">infographic</a></li>
							<li><a href="page-typography.html">Typography</a></li>
							<li><a href="page-blank.html">Blank Page</a></li>
							<li><a href="page-faq.html">FAQ</a></li>
							<li><a href="page-price-tables.html">Prices</a></li>
							<li><a href="page-our-office.html">OUR OFFICE</a></li>
							<li><a href="page-our-story.html">OUR STORY</a></li>
						...
						<dt class="item"><a href="#" class="btn-main line">Man</a></dt>
								...
								<div class="row">
										...
										<div class="row">
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category1.png" alt=""></span><a class="name" href="listing.html">Dresses</a>
													<ul>
											...
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category2.png" alt=""></span><a class="name" href="listing.html">SHIRTS</a>
													<ul>
														<li><a href="listing.html">Empty category #1</a></li>
														<li><a href="listing.html">Empty category #2</a></li>
														<li><a href="listing.html">Empty category #3</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category3.png" alt=""></span><a class="name" href="listing.html">COATS</a>
													<ul>
														<li><a href="listing.html">Empty category #4</a></li>
														<li><a href="listing.html">Empty category #5</a></li>
														<li><a href="listing.html">Empty category #6</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category7.png" alt=""></span><a class="name" href="listing.html">JACKETS</a>
													<ul>
														<li><a href="listing.html">Empty category #7</a></li>
														<li><a href="listing.html">Empty category #8</a></li>
														<li><a href="listing.html">Empty category #9</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category4.png" alt=""></span><a class="name" href="listing.html">SHORTS</a><span class="label label-cool">-15%</span>
													<ul>
											...
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category5.png" alt=""></span><a class="name" href="listing.html">JEANS</a>
													<ul>
														<li><a href="listing.html">Empty category #10</a></li>
														<li><a href="listing.html">Empty category #11</a></li>
														<li><a href="listing.html">Empty category #12</a></li>
											...
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category6.png" alt=""></span><a class="name" href="listing.html">SKIRTS</a>
													<ul>
														<li><a href="listing.html">Empty category #16</a></li>
														<li><a href="listing.html">Empty category #17</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category8.png" alt=""></span><a class="name" href="listing.html">LINGERIE</a>
													<ul>
														<li><a href="listing.html">Empty category #18</a></li>
														<li><a href="listing.html">Empty category #19</a></li>
														<li><a href="listing.html">Empty category #20</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-6 col-md-4 col-lg-3">
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category9.png" alt=""></span><a class="name" href="listing.html">Tops</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-md-3 hidden-sm hidden-xs">
										<div class="img-fullheight">
											<img class="img-responsive" src="<?=base_url();?>assets/images/menu-img-right-2.png" alt="">
										</div>
									</div>
									<!-- //end html block -->
								</div>
						...
						<dt class="item"><a href="#" class="btn-main line">Woman</a>
						...
						<div class="navbar-main-submenu">
							<div>
								Maecenas eu enim in lorem scelerisq ue auctor. Ut non erat. Suspendisse tesque sagittis. Morbi quam. Nullam ac nisi non eros gravida venenatis. Ut eu dictum justo urna et mi. Integer dictum est vitae sem.
							</div>
							<div class="wrapper">
								<div class="row">
									<!-- categories -->
									<div class="col-xs-6 col-sm-6 col-md-7 col-lg-7">
										<div class="row col-divider">
											<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
												...
												<div class="submenu-block">
													<span class="icon"><img src="<?=base_url();?>assets/images/icon-category4.png" alt=""></span><a class="name" href="listing.html">SHORTS</a>
													<ul>
														<li><a href="listing.html">Empty category #10</a></li>
														<li><a href="listing.html">Empty category #11</a></li>
														<li><a href="listing.html">Empty category #12</a></li>
														<li><a href="listing.html">Empty category #13</a></li>
													</ul>
												</div>
											</div>
											<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
									...
									<div class="col-xs-6 col-sm-6 col-md-5 col-lg-5">
										<div class="row">
													...
													<div class="header-product-carousel slick-style2">
														<div class="carousel-item">
															<div class="product-preview">
																<div class="preview">
																	<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-listing-08.jpg" alt=""></a>
																</div>
														...
														<div class="carousel-item">
															<div class="product-preview">
																<div class="preview">
																	<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-listing-01.jpg" alt=""></a>
																</div>
																<h3 class="title"><a href="product.html">Product Example</a></h3>
																<span class="price">$214.19</span>
															</div>
											...
											<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
												<a href="#"><img src="<?=base_url();?>assets/images/banner.jpg" class="img-responsive" alt=""></a>
											</div>
										</div>
									</div>
									<!-- //end html block -->
							...
							<div class="row col-divider">
								<div class="col-xs-3">
									<img src="<?=base_url();?>assets/images/logo-light.png" class="img-responsive" alt="">
								</div>
								<div class="col-xs-9">
									<h5>ABOUT US</h5>
									<p>
						...
						<dt class="item"><a href="#" class="btn-main line">Electronics</a>
						...
						<div class="navbar-main-submenu">
							...
							<div class="wrapper-border">
								<div class="row">
									...
									<div class="col-md-3 hidden-sm hidden-xs">
										<div class="img-fullheight">
											<img class="img-responsive" src="<?=base_url();?>assets/images/menu-img-right-1.png" alt="">
										</div>
									</div>
									<!-- //end html block -->
								</div>
						...
						<dt class="item"><a href="index.html" class="btn-main">BUYTHEME</a></dt>
						<dd></dd>
					</dl>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-4 col-lg-4">
					<a href="index.html" class="item anim-icon"><span class="icon"><img src="<?=base_url();?>assets/images/anim-icon-1.gif" data-hover="<?=base_url();?>assets/images/anim-icon-1-hover.gif" alt=""/></span><span class="title">Free shipping on orders over $200</span></a>
				</div>
				<div class="col-xs-12 col-sm-4 col-lg-4">
					<a href="index.html" class="item anim-icon"><span class="icon"><img src="<?=base_url();?>assets/images/anim-icon-2.gif" data-hover="<?=base_url();?>assets/images/anim-icon-2-hover.gif" alt=""/></span><span class="title">30-day returns</span></a>
				</div>
				<div class="col-xs-12 col-sm-4 col-lg-4">
					<a href="index.html" class="item anim-icon"><span class="icon"><img src="<?=base_url();?>assets/images/anim-icon-3.gif" data-hover="<?=base_url();?>assets/images/anim-icon-3-hover.gif" alt=""/></span><span class="title">24/7 Support </span></a>
				</div>
			</div>
		</div>
		</section>
  ...
  -->
		<div class="tp-banner-container hidden-xs">
			<div class="tp-banner">
				<ul>
					...
					<!-- MAIN IMAGE -->
					<img src="<?=base_url();?>assets/images/dummy.png" alt="slide1" data-lazyload="<?=base_url();?>assets/images/sliders/slide1.png">
					<!-- LAYERS img 1 -->
					<div class="tp-caption fadein fadeout rs-parallaxlevel-1" data-x="500" data-y="0" data-speed="1000" data-start="500" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 4;">
						<img src="<?=base_url();?>assets/images/sliders/slide1-1.png" alt="">
					</div>
					<!-- LAYERS img 2 -->
					<div class="tp-caption lfl fadeout rs-parallaxlevel-2" data-x="200" data-y="0" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 4;">
						<img src="<?=base_url();?>assets/images/sliders/slide1-2.png" alt="">
					</div>
					<!-- LAYERS img 3 -->
					<div class="tp-caption lfr fadeout rs-parallaxlevel-3" data-x="700" data-y="0" data-speed="1200" data-start="1600" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 4;">
						<img src="<?=base_url();?>assets/images/sliders/slide1-3.png" alt="">
					</div>
					<!-- LAYER NR. 0  -->
					...
					<!-- MAIN IMAGE -->
					<img src="<?=base_url();?>assets/images/dummy.png" alt="slide2" data-lazyload="<?=base_url();?>assets/images/sliders/slide2.jpg">
					<!-- LAYERS -->
					<!-- LAYERS img 1 -->
					<div class="tp-caption fadein fadeout rs-parallaxlevel-1" data-x="750" data-y="0" data-speed="1000" data-start="500" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 4;">
						<img src="<?=base_url();?>assets/images/sliders/slide2.gif" alt="">
					</div>
					<!-- LAYER NR. 0  -->
		...
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
				<div class="banner-circle animate fadeInDown" onclick="location.href='listing.html'">
					<div class="image">
						<img src="<?=base_url();?>assets/images/img1.jpg" alt="" class="animate-scale">
					</div>
					<div class="title">
			...
			<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
				<div class="banner-circle animate fadeInDown" onclick="location.href='listing.html'">
					<div class="image">
						<img src="<?=base_url();?>assets/images/img2.jpg" alt="" class="animate-scale">
					</div>
					<div class="title">
			...
			<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
				<div class="banner-circle animate fadeInDown" onclick="location.href='listing.html'">
					<div class="image">
						<img src="<?=base_url();?>assets/images/img3.jpg" alt="" class="animate-scale">
					</div>
					<div class="title">
			...
			<div class="products-nospace">
				<div class="slides row1">
					<div class="carousel-item 1">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product1.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
					...
					<div class="carousel-item 2">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product2.jpg" alt=""></a>
					...
					<div class="carousel-item 3">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product3.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 4">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product4.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 5">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product5.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 6">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product6.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 7">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product7.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 8">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product8.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 9">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product9.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
					...
					<div class="carousel-item 10">
						<div class="product-preview">
							<a href="#" class="preview-image"><img class="img-default" src="<?=base_url();?>assets/images/products/product10.jpg" alt=""></a>
							<div class="hover">
								<div class="inside">
									<h3 class="title"><a href="product.html">Long Product name Example</a></h3>
									<span class="price new">$214.99</span><span class="price old">$214.99</span>
			...
			<div class="product-carousel">
					...
					<div class="product-preview">
						<div class="preview">
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-01.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
				...
				<div class="carousel-item">
					<div class="product-preview">
						<div class="preview">
							...
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
							<a href="_ajax_view-product.html" class="quick-view"><span>Quick View</span></a>
						</div>
						<h3 class="title"><a href="product.html">Product Example</a></h3>
				...
				<div class="carousel-item">
					<div class="product-preview">
						<div class="preview">
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-03.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
							<a href="_ajax_view-product.html" class="quick-view"><span>Quick View</span></a>
						</div>
				...
				<div class="carousel-item">
					<div class="product-preview">
						<div class="preview">
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-04.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
							<a href="_ajax_view-product.html" class="quick-view"><span>Quick View</span></a>
						</div>
						<h3 class="title"><a href="product.html">Product Example</a></h3>
				...
				<div class="carousel-item">
					<div class="product-preview">
						<div class="preview">
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-05.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
							<a href="_ajax_view-product.html" class="quick-view"><span>Quick View</span></a>
						</div>
						<h3 class="title"><a href="product.html">Product Example</a></h3>
				...
				<div class="carousel-item">
					<div class="product-preview">
						<div class="preview">
							<div class="preview-image-outer">
								<a href="product.html" class="preview-image"><img class="img-responsive img-default" src="<?=base_url();?>assets/images/products/product-06.jpg" alt=""><img class="img-responsive img-second" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
							</div>
							<a href="_ajax_view-product.html" class="quick-view"><span>Quick View</span></a>
						</div>
						<h3 class="title"><a href="product.html">Product Example</a></h3>
		...
		<div class="container content">
			<div class="posts">
				...
				<div class="slides slick-style3">
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-01.jpg" alt=""><span class="info">Blog post number 1 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-02.jpg" alt=""><span class="info">Blog post number 2 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-03.jpg" alt=""><span class="info">Blog post number 3 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-04.jpg" alt=""><span class="info">Blog post number 4 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-05.jpg" alt=""><span class="info">Blog post number 5 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-01.jpg" alt=""><span class="info">Blog post number 6 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-02.jpg" alt=""><span class="info">Blog post number 7 <span class="date">September 02, 2015</span></span></a>
					</div>
					<div class="carousel-item">
						<a href="blog-single.html"><img src="<?=base_url();?>assets/images/blog/blog-img-03.jpg" alt=""><span class="info">Blog post number 8 <span class="date">September 02, 2015</span></span></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="brands-carousel">
			<div class="slides">
				...
				<div>
					<a href="#"><img src="<?=base_url();?>assets/images/brand7.png" alt=""></a>
				</div>
				<div>
					<a href="#"><img src="<?=base_url();?>assets/images/brand8.png" alt=""></a>
				</div>
			</div>
		</div>
		</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-3 col-lg-3">
					...
					<div class="widget-outer">
						<p>
							<img src="<?=base_url();?>assets/images/img-about.jpg" alt="" class="img-responsive">
						</p>
						<p>
					...
					<div class="products-widget vertical">
						<div class="slides slick-style2">
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-02.jpg" alt=""></a>
									</div>
									<p class="name">
							...
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-01.jpg" alt=""></a>
									</div>
									<p class="name">
										<a href="product.html">Product Example</a>
									</p>
							...
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-03.jpg" alt=""></a>
									</div>
									<p class="name">
										<a href="product.html">Product Example</a>
									</p>
							...
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-04.jpg" alt=""></a>
									</div>
									<p class="name">
										<a href="product.html">Product Example</a>
									</p>
							...
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-05.jpg" alt=""></a>
									</div>
									<p class="name">
										<a href="product.html">Product Example</a>
									</p>
							...
							<div class="carousel-item">
								<div class="product">
									<div class="preview-image-outer">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/products/product-06.jpg" alt=""></a>
									</div>
									<p class="name">
										<a href="product.html">Product Example</a>
									</p>
					...
					<div class="blog-widget-small vertical">
						<div class="slides slick-style2">
							<div class="carousel-item">
								<div class="post">
									<div class="image">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/img-resent-1.jpg" alt=""></a>
									</div>
									<div class="text">
										<div class="text">
											<p class="name">
							...
							<div class="carousel-item">
								<div class="post">
									<div class="image">
										<a href="product.html" class="preview-image"><img class="img-responsive" src="<?=base_url();?>assets/images/img-resent-2.jpg" alt=""></a>
									</div>
									<div class="text">
										<div class="text">
											<p class="name">
			...
			<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 hidden-xs">
				...
				<div class="pull-left padding-left">
					<div class="small-photos">
						<a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-1.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-2.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-3.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-4.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-5.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-6.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-7.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-8.jpg" alt=""></a><a href="gallery-single.html"><img src="<?=base_url();?>assets/images/flickr-photo-9.jpg" alt=""></a>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 copyright">
							© 2015 <a href="#">Coolbaby</a>. All Rights Reserved.
						</div>
						<div class="col-md-4">
							<ul class="payment-list pull-right">
								<li><img src="<?=base_url();?>assets/images/icon-payment-01.png" width="36" height="22" alt=""></li>
								<li><img src="<?=base_url();?>assets/images/icon-payment-02.png" width="36" height="22" alt=""></li>
								<li><img src="<?=base_url();?>assets/images/icon-payment-03.png" width="36" height="22" alt=""></li>
								<li><img src="<?=base_url();?>assets/images/icon-payment-04.png" width="36" height="22" alt=""></li>
								<li><img src="<?=base_url();?>assets/images/icon-payment-05.png" width="36" height="22" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
...
<script src="<?=$base;?>js/modernizr.custom.02163.js"></script>
<script src="<?=$base;?>js/jquery.finger.min.js"></script>
<script src="<?=$base;?>js/doubletaptogo.js"></script>
<script src="<?=$base;?>js/bootstrap.min.js"></script>
<script src="<?=$base;?>js/jquery.easing.1.3.min.js"></script>
<script src="<?=$base;?>js/slick.min.js"></script>
<script src="<?=$base;?>js/jquery.parallax.min.js"></script>
<script src="<?=$base;?>js/jquery.inview.min.js"></script>
<script src="<?=$base;?>js/jquery.liMarquee.min.js"></script>
<script src="<?=$base;?>js/jquery.colorbox-min.js"></script>
<script src="<?=$base;?>js/jquery.plugin.min.js"></script>
<script src="<?=$base;?>js/jquery.countdown.min.js"></script>
<script src="<?=$base;?>js/coolbaby.js"></script>
<!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
<script type="text/javascript" src="<?=$base;?>rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="<?=$base;?>rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="<?=$base;?>rs-plugin/js/jquery.themepunch.ini.js"></script>
</body>
</html>