					...
					<div class="navbar-collapse collapse" id="navbar-filter">
						<ul class="nav navbar-nav">
						 <li class="active"><a href="#settings" data-toggle="tab"><i class="icon-cog3 position-left"></i> Settings</a></li>
							<li ><a href="#activity" data-toggle="tab"><i class="icon-plus position-left"></i> Add Permissions</a></li>
							...
							<div class="tabbable">
								<div class="tab-content">
									<div class="tab-pane in active fade" id="settings">
									    <?php $data['role_id'] = $role_id;?>
										<?php $this->load->view('admin/templates/edit_roles',$data);?>
									</div>
									<div class="tab-pane fade in " id="activity">
									    <?php $this->load->view('admin/templates/add_Permissions');?>
