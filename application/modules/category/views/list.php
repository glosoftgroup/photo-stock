	        ...
	        <div class="panel-body  search-panel" style="padding:5px;">
	            <div class="col-md-2">
	              ...
	              <div class="form-group">
	                    <a id="toggle-add-form" href="<?=base_url('category/add');?>" class="btn btn-primary hvr-glow btn-raised legitRipple waves-effect waves-light">
...
<input type="hidden" class="pageUrls"
  data-listurl="<?=base_url('category/get_list');?>"
>
