<header class="transparent">
	<div class="container">
		<div class="row">
			<div class="col-md-2">
				<div class="logo"><a href="index.html"><img src="<?=img_url('frontend');?>/logo.svg" alt="logo"></a></div>
			</div>
			<div class="col-md-7">
				<ul class="menu">
	...
	<div class="mobile-block">
		<div class="logo-mobile"><a href="index.html"><img src="<?=img_url('frontend');?>/logo.svg" alt="logo"></a></div>
		<a href="#" class="mobile-menu-btn"><span></span></a>
		<div class="mobile-menu">
			<div class="inside">
				<div class="logo">
					<a href="index.html"><img src="<?=img_url('frontend');?>/logo.svg" alt="logo"></a>
				</div><!--logo-->
